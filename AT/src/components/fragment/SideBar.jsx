    ...
    return (
        <aside style={useStyle.component} className={"aside-bar"}>
            ...
            <div className="aside-bar-container playlist">
                ...
                <SideBarOptions className={"lib-sub"} Icon={PlaylistPlay} href={"/home/playlist/latest-songs"}  title={"Latest Songs"}/>
                <SideBarOptions className={"lib-sub"} Icon={PlaylistPlay} href={"/home/playlist/favourite"}  title={"Favourite"}/>
                <SideBarOptions className={"lib-sub"} Icon={PlaylistPlay} href={"/home/playlist/all-time"}  title={"All Time"}/>
            </div>
        </aside>
    );
}
